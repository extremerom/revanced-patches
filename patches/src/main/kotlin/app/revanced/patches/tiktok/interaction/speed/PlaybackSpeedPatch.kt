        ...
        setSpeedFingerprint.let { onVideoSwiped ->
            ...
            onRenderFirstFrameFingerprint.method.addInstructions(
                ...
                """
                    ...
                    # Video playback location (e.g. home page, following page or search result page) retrieved using getEnterFrom method (K5).
                    const/4 v0, 0x1
                    ...
                    # Empty string for last parameter
                    const/4 v6, 0x0
                    
                    invoke-static/range { v1 .. v6 }, ${onVideoSwiped.originalMethod}
                """,
            )
